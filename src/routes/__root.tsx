...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "IsaHaven" },
      { name: "apple-mobile-web-app-status-bar-style", content: "default" },

      { title: "IsaHaven — hogar de IsaBot 💕" },
      { name: "description", content: "IsaHaven: el hogar digital de herramientas, IA y comunidad, con IsaBot." },
      { name: "author", content: "Isabella Rodríguez Roque" },
      { property: "og:title", content: "IsaHaven — hogar de IsaBot 💕" },
      { property: "og:description", content: "IsaHaven: el hogar digital de herramientas, IA y comunidad, con IsaBot." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "IsaHaven — hogar de IsaBot 💕" },
      { name: "twitter:description", content: "IsaHaven: el hogar digital de herramientas, IA y comunidad, con IsaBot." },
