...
export const ISA_THEMES: IsaTheme[] = [
  ...
  { id: "pastel", name: "Pastel Dream", emoji: "🍬", tagline: "Menta, lila y durazno suave", price: 15, swatch: ["#ffd6ec", "#c7f0ea", "#fff6e5"] },
  { id: "neon", name: "Dark Neon", emoji: "⚡", tagline: "Modo oscuro cyber con neón cian", price: 25, swatch: ["#0b0f1e", "#00e5ff", "#ff3ea5"] },
  { id: "sakura", name: "Sakura Blossom", emoji: "🌸", tagline: "Pétalos rosados y verde jade", price: 20, swatch: ["#ffc2d4", "#f7f0ff", "#8ac6a4"] },
  { id: "golden", name: "Golden Luxe", emoji: "👑", tagline: "Oro pulido sobre carbón", price: 35, swatch: ["#1a1508", "#e3bc6d", "#fff3cf"] },
